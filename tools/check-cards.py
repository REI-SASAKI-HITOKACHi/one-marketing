...
MIKAKUTEI = {
    # 内視鏡カメラ（DHWC125Ⅱ）は 2026-09-22 に「届いている」と確認が取れたので外した
    "ATP": "ATP測定器は「無い」（和真さん回答 2026-09-22）。書けない",
    "ルミテスター": "ATP測定器は「無い」（同上）。パンフレットの『ルミテスター』が同じ物かを cmo が確認中",
    "数値で測る": "ATP測定器は「無い」（同上）。測れないものを測ると書けない",
}

...
# 和真さん回答（9/22 14:18 LINE）：①〜⑥はタカラサービス経由（施工先名は台帳に無い）、⑦はクラスリフォーム（外した）。
JOBS = [
    ...
    ("24GYM 様", "2023年11月", "—"),
    ("御社からのご依頼（墨田区・店舗）", "2023年9月", "業務用エアコン 複数台"),
    ("御社からのご依頼", "2024年9月", "業務用エアコン／ドレンパン洗浄 2台"),
    ("御社からのご依頼", "2026年2月", "床置き型 2台、壁掛け4台＋天吊り1台"),
]

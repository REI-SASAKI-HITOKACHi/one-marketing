...
UNEI_TANTOU = "佐々木 沙樹"   # 代表取締役。オーナー（掲示板の owner）の佐々木 嶺とは別人。公開物の「代表」は沙樹（2026-09-13 オーナー指摘）
...
BOOKING = "https://yoyaku.onehitter.jp/"  # 2026-09-12 旧ホスト one-hitter-booking はセーフブラウジング判定のため載せ替え（20260912-10）
TENKEN_URL = "https://tenken.onehitter.jp"      # 無料点検サイト（未作成なら --create で作る）
DOKUHON_URL = "https://dokuhon.onehitter.jp"    # 読本サイト（同上）

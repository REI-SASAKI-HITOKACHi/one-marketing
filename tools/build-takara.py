...
#
# ★2026-09-20 訂正★ 提携タブに入っていた4件（2026/02/27 ¥22,000・2026/03/07 ¥22,000・
# 2026/03/12 ¥55,000・2026/03/16 ¥70,400 ＝ ¥169,400）は、**クラスリフォームさまの案件**だった
# （和真さん回答 2026-09-20 10:34／cmo が提携タブを訂正 f5728e4）。17件・¥777,690 → **13件・¥608,290**。
# 合計はシートの日付・金額の対を1つずつ読み直して検算した。
#
# ★1件あたりは、シートの「平均単価」欄を使わないこと。★
# あの欄は訂正後も ¥35,782（＝¥608,290 ÷ 17）のままで、**17で割ったまま追従していない**。
# ここは 合計 ÷ 件数（¥608,290 ÷ 13 = ¥46,791.5…）で出している。
KENSU = "13件"
RUIKEI = "608,290円（税込）"

...
<div class="box kiiro nobreak">
<div class="midashi">数え方の話をもう1つ。大きい案件を年に何件取るか。</div>
<p>提携先の案件は1件の大きさがバラバラだ。5〜8月の26件を平均すると<strong>11.4万</strong>だが、BREXAの1件を抜くと<strong>5.1万</strong>になる。計画は1件10万で置いている。</p>
<p><strong>つまり計画は、100万を超える案件が年に2〜3件出ることを当てにしている。</strong>2026年は1件（BREXA 168万）だった。</p>
<table><thead><tr><th>750万をどう作るか</th><th>必要な件数</th></tr></thead><tbody>
<tr><td>100万超が1件も出ない年（1件5.1万）</td><td><b>153件</b></td></tr>
<tr><td>168万の大型が1件出る年</td><td><b>119件</b></td></tr>
<tr><td>計画の置き方</td><td><b>大型2〜3件＋72〜73件＝75件</b></td></tr>
</tbody></table>
<p style="margin-bottom:0">大型が0件の年は、同じ750万を作るのに<strong>件数を倍動かすことになる</strong>（75件→153件）。手は足りるが、動く回数が倍だ。だから社数（10社→15社）とは別に、<span class="hikari">100万超の案件を年2件、を目標に置きたい。</span>BREXAのような施設・法人の天カセ案件がいちばん現実的で、施設リスト291件はそこに当たる。</p>
</div>
...
<p><strong>ハウスクリーニングを贈り物として売る。</strong>これは和真も知ってのとおり、<strong>過去に何度かやろうとして、そのたび中途半端に終わってきた施策</strong>だ。今度は本気でやる。来年は別ブランドとして切り出して、専用のページと商品設計を用意する。</p>

<p class="kome">※やる前に、<strong>前に止まった理由を和真から聞かせてほしい。</strong>いつ・どういう形で出して・どこまで進んで・何で止まったか。同じ理由で3回止まっているなら、そこを潰さないと4回目も同じになる。</p>

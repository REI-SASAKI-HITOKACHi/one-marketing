...
def shihanki_hyou():
    out = ['<table class="sum"><thead><tr><th>四半期</th><th>売上</th><th>件数</th>'
           '<th>営業利益</th><th>経常利益</th><th>経常利益 累計</th></tr></thead><tbody>']
    ruikei = 0
    for q, (a, b) in {1: (1, 3), 2: (4, 6), 3: (7, 9), 4: (10, 12)}.items():
        rs = [r for r in GYOU if a <= r['月'] <= b]
        kj = sum(r['経常利益'] for r in rs)
        ruikei += kj
        out.append(f'<tr><th>Q{q}　{a}〜{b}月</th><td>{en(sum(r["売上"] for r in rs))}</td>'
                   f'<td>{sum(r["件数"] for r in rs)}</td>'
                   f'<td>{en(sum(r["営業利益"] for r in rs))}</td>'
                   f'<td class="{"neg" if kj < 0 else ""}">{en(kj)}</td><td>{en(ruikei)}</td></tr>')
    out.append(f'<tr class="b"><th>年計</th><td>{en(G["売上"])}</td><td>{G["件数"]}</td>'
               f'<td>{en(G["営業利益"])}</td><td>{en(G["経常利益"])}</td><td>{en(G["経常利益"])}</td></tr>')
    out.append('</tbody></table>')
    return '\n'.join(out)
...
<div class="hyoushi">
  ...
  <h1>2027年の計画</h1>
  <div class="sub">売上 2,600万円 ／ 経常利益 585万円</div>
  <div class="rule"></div>
  <div class="meta">
    社内用　―　渡辺 和真 へ<br>
    2026年9月13日　作成：佐々木<br>
    ※この資料の数字は当面この前提で動く。変わったら差し替える。
  </div>
  <div class="box">
    <b>この資料で伝えたいこと</b>
    <p style="margin-top:8px">
      来年から会社のスケールを上げる。人を1人増やして、協力業者を3社入れる。<br>
      そのぶん固定費が年600万増えるから、売上を6割伸ばしてようやく利益が今年を少し超える。<br>
...
<tr><td>2026年（見込み）</td><td>約440</td><td>約16,260,000</td><td>約36,900</td><td><b>+4%</b></td></tr>
</tbody></table>

<p>2023年が+16%、2024年が+21%で伸びていた。2026年は+4%で終わる見込みだ。予算は2,000万で置いていたから、達成率でいうと8割くらいになる。<strong>数字だけ見れば止まっている。</strong></p>

<p>ただ、止まった理由ははっきりしている。そして直せる。</p>

<div class="box aka nobreak">
<div class="midashi">原因は現場じゃない。入口がないことだ。</div>
<p>2026年の9〜12月に入っている受注37件のうち、<strong>73%は渡辺が現場で取った次回予約</strong>だ。HP・LINE・SMS・地図検索から来た受注は、この4か月で<strong>ゼロ</strong>。</p>
<p>つまり会社の売上が、渡辺が目の前のお客様に声をかけるかどうかだけで決まっている。それで回っているのは正直すごいことだけど、これ以上は伸びない。渡辺の1日は24時間しかないから。</p>
</div>
...
<p style="font-size:14pt;line-height:1.6;margin-bottom:6px"><strong>売上 2,600万円　／　経常利益 585万円　／　施工 649件</strong></p>
<p class="kome" style="margin:0">2026年の見込み（約1,626万円）から +60%。</p>
</div>

<p>「+60%も伸ばして、利益は今年とほとんど変わらないのか」と思うはずだ。そのとおりだ。理由は、来年から固定費が年600万円増えるから。</p>

<table class="futsu nobreak">
<thead><tr><th>新しく増える固定費</th><th>年額</th><th>中身</th></tr></thead>
<tbody>
<tr><td>渡辺の報酬</td><td>+180万</td><td>今年9月分から固定給40万＋プール10万＝月50万（年600万）。前の歩合だと年420万くらいだった</td></tr>
...
<tr class="b"><td><b>合計</b></td><td><b>約598万</b></td><td>売上に関係なく毎月出ていく</td></tr>
</tbody></table>

<p>この600万が先に出ていくので、売上がそれを超えて伸びないと利益は減る。計算するとこうなる。</p>

<table class="futsu nobreak">
<thead><tr><th>　</th><th>必要な売上</th></tr></thead>
<tbody>
<tr><td>赤字にならない最低ライン（損益分岐点）</td><td><b>約1,830万円</b></td></tr>
<tr><td>2026年と同じ利益（約481万円）を残すライン</td><td><b>約2,460万円</b></td></tr>
<tr><td><b>2027年の目標</b></td><td><b>2,600万円</b></td></tr>
</tbody></table>

<div class="box kiiro nobreak">
<div class="midashi">だから 2,600万は「安全な目標」じゃない。</div>
<p>これが<strong>ギリギリ増益になる線</strong>だと思っておいてほしい。ここを下回ると、去年より稼いだのに利益は減る、という年になる。</p>
</div>

<h3>3つのパターンで見ている</h3>

<table class="futsu nobreak">
<thead><tr><th>　</th><th>保守</th><th>中立（目標）</th><th>攻め</th></tr></thead>
<tbody>
<tr><td>売上</td><td>2,000万</td><td><b>2,600万</b></td><td>3,200万</td></tr>
<tr><td>件数</td><td>513件</td><td><b>649件</b></td><td>774件</td></tr>
<tr><td>平均単価</td><td>38,986円</td><td><b>40,062円</b></td><td>41,344円</td></tr>
<tr><td>経常利益</td><td>190万</td><td><b>585万</b></td><td>985万</td></tr>
<tr><td>2026年（481万）との差</td><td class="neg">▲291万</td><td><b>+104万</b></td><td><b>+504万</b></td></tr>
<tr><td>赤字になる月</td><td class="neg">2月・8月・9月・12月</td><td>2月だけ</td><td>なし</td></tr>
</tbody></table>

<p><strong>会社として置く目標は「中立 2,600万」。</strong>ただ僕の中ではその上、3,200万を見ている。そこまで行けば経常利益は985万で、今年のちょうど2倍になる。公式の目標にはしないが、頭には入れておいてほしい。</p>

<p>保守の2,000万というのは「来年も今年と同じやり方をしたらこうなる」という線だ。黒字ではあるけど、利益は今年より291万減って、年に4か月が赤字月になる。ここに落ちたら固定費を削りにいくことになる。</p>
</div>
...
<li>ただし来年は、その薄い時期に新しい人件費が乗る。だから1〜2月は<strong>早期予約の15%割引</strong>と、<strong>不動産管理会社の空室清掃</strong>（相手の繁忙期が2〜3月で、うちの閑散期と噛み合う）で埋めにいく。</li>
...
<tbody>
<tr><td>渡辺</td><td>月50万（年600万）</td><td>固定給40万＋プール10万。プールは3か月ごとに払い出す</td></tr>
...
<h3>広告費</h3>
<p>年80万。<strong>年額を先に決めるんじゃなくて、小さく試して結果が出たら上げる。</strong></p>
<table class="futsu nobreak">
<thead><tr><th>段</th><th>月額</th><th>次の段へ上がる条件</th></tr></thead>
<tbody>
<tr><td>0　テスト（1〜2月）</td><td>5万</td><td>無条件で出す</td></tr>
<tr><td>1</td><td>6〜10万</td><td>段0でCPAが9,500円以下</td></tr>
<tr><td>2　繁忙期（5〜7月）</td><td>12〜15万</td><td>段1を2か月続けてクリア</td></tr>
<tr><td>3　年末（10〜11月）</td><td>7〜10万</td><td>段2をクリア</td></tr>
</tbody></table>
<p>CPA（1件取るのにかかる広告費）の上限は<strong>9,500円</strong>。これは楽ラクーンに払っている手数料と同じ額だから、ここを下回る限り広告のほうが得だという意味になる。<strong>月のCPAが9,500円を超えたら、その月で止める。</strong></p>
<p class="kome">※Facebook広告は再開しない（前にやってCPC95円・1件6,000円で撃沈した）。チラシの単独配布もしない（週2,000枚で反応0）。</p>
...
<tbody>
<tr><td>① 自社リピート資産（リピート・早期予約・紹介・定期便）</td><td>592万</td><td>850万</td><td>+258万</td></tr>
<tr><td>② 法人・提携（業務提携・営業・入札）</td><td>630万</td><td>800万</td><td>+170万</td></tr>
<tr><td>③ マッチングPF（楽ラクーン・スケジュールマッチング）</td><td>374万</td><td>430万</td><td>+56万</td></tr>
<tr class="b"><td>④ <b>自社ネット新規</b>（LP・SNS・地図検索・アフィリエイト・LINE/SMS再販）</td><td><b>13万</b></td><td><b>500万</b></td><td><b>+487万</b></td></tr>
<tr><td>⑤ その他（チラシほか）</td><td>20万</td><td>20万</td><td>―</td></tr>
<tr class="b"><td>合計</td><td>1,629万</td><td>2,600万</td><td>+971万</td></tr>
</tbody></table>

<p><span class="hikari">増える971万のうち、487万が④だ。</span>ここが動かなければ、他を全部うまくやっても目標には届かない。</p>

<h3>① 自社リピート資産　592万 → 850万</h3>
<p>台帳の957人がすべて。獲得コストはほぼゼロで、いちばん確実な伸びしろだ。</p>
<p><strong>渡辺にお願いしたいのはここだ。現場で「次の1箇所」を出すこと。</strong>換気扇をまだ頼んでいない人が807人、浴室が780人いる。エアコンで入ったお客様に、その場で水回りの話をする。それだけで1人あたりの金額が5万円変わる。</p>
...
<h3>② 法人・提携　630万 → 800万</h3>
<p>業務提携の平均単価は<strong>10万円</strong>。個人の2倍以上で、法人のLTVは個人の3.9倍だ。提携先を2社から4社に増やす。</p>
<p>入口は、施設リスト291件への営業と、不動産管理会社の空室清掃（1件58,080円〜）。冷たいテレアポはやらない（過去に40件→0アポ、140件→0アポ）。</p>

<h3>③ マッチングPF　374万 → 430万（意図して増やさない）</h3>
<p>手数料を35%払って、戻ってくるのは<strong>100人に2人</strong>だけ。数を増やしても資産にならない。件数は協力業者に回して、うちの枠を単価の高い①②④に空ける。</p>
...
<div class="sec">
<h2><span class="no">7</span>新しい柱 ―― ハウスクリーニングをギフトにする</h2>

<p class="lead">これは来年の数字には入れていない。ただ、来年中に立ち上げたい。</p>

<p><strong>ハウスクリーニングを贈り物として売る。</strong>出産祝い、新築祝い、引越し祝い、母の日、敬老の日、法人の福利厚生や株主優待。カタログギフトの1メニューとして載っていることはあるが、<strong>ここを専門にしてポジションを取っている会社は、まだ見当たらない。</strong></p>

<h3>なぜやるのか</h3>

<div class="step"><div class="n">1</div><div>
<b>贈り物は、買う人と使う人が別だ。</b>つまり1件で新規の接点が2つできる。しかも贈られた側は「無料で体験した状態」でリピートの土俵に乗る。<b>獲得コストは贈り主が払ってくれている。</b>いまのマッチングPFは1件9,500円払って、戻ってくるのは100人に2人。構造がまるごと逆になる。
</div></div>

<div class="step"><div class="n">2</div><div>
<b>先に金が入る。</b>ギフト券として売れば、代金を受け取ってから施工する。<b>1〜2月のいちばん薄い時期に、前受けの現金が入る</b>のは大きい。上の月次表で2月が赤字になっているが、ここに効く。
</div></div>

<div class="step"><div class="n">3</div><div>
<b>読本がそのまま武器になる。</b>いま公開した赤ちゃん版の読本は「子どもが生まれる家のエアコンを洗う」話だ。<b>出産祝いのギフトとして、これ以上ない導線になる。</b>ペット版も同じ。
</div></div>

<div class="step"><div class="n">4</div><div>
<b>贈り物は「外さないこと」が全てで、うちにはその証拠がある。</b>Google クチコミ★5.0が24件、アンケート満足度98.6%（209名中206名）、ルミテスターのATP値が42,194から409まで落ちる数字。贈り物として選ばれるのに必要なものは、もう揃っている。
</div></div>

<h3>なぜ別ブランドにするのか</h3>
<p>ONE HITTERは「エアコンクリーニングの会社」として探される。ギフトは探し方がまったく違う（「出産祝い 変わったもの」「新築祝い 実用的」）。同じ看板でやると両方ぼやけるし、価格の見え方も違う。<strong>ギフトは「いくらの贈り物か」が主語になる</strong>から、セットで2〜3万円の商品設計になる。エアコン1台10,780円という売り方では、贈り物の棚に並ばない。</p>

<h3>制約もはっきりしている</h3>
<ul>
<li>うちが施工できるのは<strong>東京・千葉・神奈川だけ</strong>。贈り主は相手の住所を正確に知らないことがある。購入画面で郵便番号を必ず確認する仕組みが要る</li>
<li>ギフト券の<strong>有効期限と表示のルール</strong>（資金決済法・景品表示法）を先に確認する</li>
<li>施工日の調整を、贈り主ではなく<strong>贈られた側</strong>とやることになる。現場の手数が増えないやり方を先に決める</li>
<li><strong>使われずに期限が切れた分を収益の柱にしない。</strong>それをやるとブランドが傷む</li>
</ul>
...
<tbody>
<tr><td>1〜3月</td><td>ブランド名とドメイン、LP1本、ギフト券の仕組み（コード発行→予約フォーム連携）、法務の確認</td></tr>
<tr><td>4〜6月</td><td>母の日（5月）で初回テスト。少額の広告</td></tr>
<tr><td>7〜9月</td><td>お中元・敬老の日。出産祝いは通年</td></tr>
<tr><td>10〜12月</td><td>年末・お歳暮。法人（福利厚生・株主優待・住宅メーカーの引渡し記念）へ展開</td></tr>
</tbody></table>

<p><strong>2027年の売上目標（2,600万）には入れない。</strong>立ち上げに半年かかるからだ。上振れ要因として置いて、<span class="hikari">2028年の柱にする。</span></p>
</div>

<div class="sec">
<h2><span class="no">8</span>人を増やす</h2>
...
<p>3月というのは計画上の話で、実際はもっと早く入れたい。前倒しできるなら前倒しする。</p>

<h3>協力業者3社を1〜2月に決めて、3月から動かす</h3>

<p>これは「安く回す先」じゃない。<strong>繁忙期に取りこぼさないための保険</strong>だ。5〜7月と年末は、うちの2人だけだと確実に断る日が出る。<span class="hikari">断った1件は二度と戻ってこない。</span></p>
...
<div class="box nobreak">
<div class="midashi">渡辺に頼みたいのは、この2つだ。</div>
<div class="step"><div class="n">1</div><div>
...
<div class="sec">
<h2><span class="no">9</span>四半期ごとに見る数字</h2>

<p>毎月こまかく見るのは大変なので、<strong>締めるのは四半期末（3月末・6月末・9月末・12月末）の4回</strong>にする。</p>

<table class="futsu nobreak">
<thead><tr><th>　</th><th>3月末</th><th>6月末</th><th>9月末</th><th>12月末</th></tr></thead>
<tbody>
<tr><td>累計 売上（目標）</td><td>457万</td><td>1,312万</td><td>1,926万</td><td><b>2,600万</b></td></tr>
<tr><td>累計 件数</td><td>115件</td><td>324件</td><td>480件</td><td><b>649件</b></td></tr>
<tr><td>累計 経常利益</td><td>45万</td><td>327万</td><td>446万</td><td><b>585万</b></td></tr>
</tbody></table>
...
<div class="box nobreak">
<div class="step"><div class="n">1</div><div>
<b>自社ネット新規が、月に何件来たか。</b>（目標：月12件）<br>
<span class="kome">これが動かなければ、他を全部やっても届かない。逆にここが動けば他は後からついてくる。</span>
</div></div>
<div class="step"><div class="n">2</div><div>
<b>提携先が何社になったか。</b>（2社 → 4社）<br>
<span class="kome">1社増えると年100万円規模で効く。</span>
</div></div>
</div>
...
<thead><tr><th>時期</th><th>やること</th></tr></thead>
<tbody>
<tr><td><b>1〜3月</b><br>年間の底</td><td>早期予約15%割引を既存のお客様へ。空室清掃の営業（相手の繁忙期）。協力業者3社を決めて3月から稼働。新人が3月入社。広告は月5万でテスト。ギフトブランドの立ち上げ準備</td></tr>
<tr><td><b>4〜6月</b><br>最大の稼ぎ時</td><td>エアコン需要期。5〜7月は繁忙期加算+3,300円。新人のOJTを回して<b>6月に独り立ち</b>。広告を月12万まで上げる。ピークは協力業者で吸収。母の日でギフトの初回テスト</td></tr>
<tr><td><b>7〜9月</b><br>谷を埋める</td><td>7月のあとに来る谷が最大の課題。法人・施設の開拓、提携3社目・4社目。エアコン以外（換気扇・浴室）へのクロスセル</td></tr>
<tr><td><b>10〜12月</b><br>年末商戦</td><td>年末LPは10月1日に公開されている状態で入る（検索が立ち上がるのが10月中旬）。12月の繁忙期加算を「11月までに予約する理由」として使う。既存客への案内を3波</td></tr>
</tbody></table>
...
※協力業者の支払条件、ギフト事業の詳細、広告の出稿先は未確定。決まり次第この資料を差し替える。
</footer>
</div>
"""

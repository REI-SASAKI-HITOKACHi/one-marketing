...
/**
 * 70歳以上の募集方法。
 * 別紙は「＜１＞および＜２＞によって募集します。ただし＜１＞が困難な場合、
 * ＜２＞および＜３＞での募集も可能です」と、必ず2つの組み合わせを求めている。
 * 単独の＜２＞だけでは基準を満たさないので、選択肢を組み合わせで持つ。
 */
var ELDERLY_METHODS = [
  '＜１＞70歳未満の親族の同席をともなった募集　＋　＜２＞複数回の面談による募集',
  '＜２＞複数回の面談による募集　＋　＜３＞70歳未満の親族への説明（＜１＞が困難な場合）'
];
